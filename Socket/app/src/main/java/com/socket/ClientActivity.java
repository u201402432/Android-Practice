...
public class ClientActivity extends Activity {
    ...
    String ip="45.64.145.72"; //서버 단말기의 IP주소..
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            os.writeUTF((edit_msg.getText().toString())) ;
